...
class tx():
   ...
   def put(self, data):
      ...
      sys.stdout.write("\nInvio '%s'\n" % data)
      #sys.stdout.write("1,0," % data)
      #self.wf.append(pigpio.pulse(self.txbit, 0, 500))
      #self.wf.append(pigpio.pulse(0, self.txbit, 10000))
      ...
      print "\nLunghezza messaggio: %d" % len(self.wf)
...
if __name__ == "__main__":
   ...
   BPS=480 #corrispondono a 600 nei PIC con oscillatore interno a 4MHz
