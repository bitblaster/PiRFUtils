...
if __name__ == "__main__":
   ...
   rx=SniffAndPlay.rx(pi, gpio=RX, callback=rx_callback)
   ...
   if args > 1:
      ...
      #tx=SniffAndPlay.tx(pi, gpio=TX)
      tx=SniffAndPlay.tx(pi, gpio=TX, repeats=3, bits=24, gap=14125, t0=450, t1=1372)
